...
describe('Config Tests', function () {
    ...
    it('Verify the contents of Solarweave Config', function () {
        ...
        assert_1.equal(Config_1.SolarweaveConfig.debug, false);
    ...
    it('Should be able to update the Solarweave Config', function () {
        Config_1.UpdateConfig('2.0', 'solarweave-devnet', 'https://arweave.dev/graphql', 'https://devnet.solana.com', '.arweave.creds.json', false, 'solarweave.cache.json', true, false, true, 1, 1, false, true, false);
    });
});
