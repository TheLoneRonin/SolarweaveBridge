 ...
 */
var DataItemJson = /** @class */ (function () {
    function DataItemJson() {
        this.owner = '';
        this.target = '';
        this.nonce = '';
        this.tags = [];
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, deps.deepHash([
                    ...
                    __spread(d.tags.map(function (tag) {
                        return [deps.utils.b64UrlToBuffer(tag.name), deps.utils.b64UrlToBuffer(tag.value)];
                    })),
